#include "wings_control_ux.h"
#include "http_server_ux.h"
...
"<div>"
"<label>角度范围限制:</label>"
"<div>最小角度: <input type=\"number\" id=\"min-angle\" class=\"angle-limit-input\" min=\"0\" max=\"270\" value=\"45\" onchange=\"updateAngleLimits()\">°</div>"
"<div>最大角度: <input type=\"number\" id=\"max-angle\" class=\"angle-limit-input\" min=\"0\" max=\"270\" value=\"225\" onchange=\"updateAngleLimits()\">°</div>"
"</div>"
...
"<label>左翅膀速度 (100-1500ms): <input type=\"number\" id=\"left-speed\" class=\"speed-input\" min=\"100\" max=\"1500\" value=\"1000\" onchange=\"updateSpeed('left')\"></label>"
"</div>"
...
"<label>右翅膀速度 (100-1500ms): <input type=\"number\" id=\"right-speed\" class=\"speed-input\" min=\"100\" max=\"1500\" value=\"1000\" onchange=\"updateSpeed('right')\"></label>"
"</div>"
"</div>"
